...
- 关键参数的选择依据:
  (1)max_iterations：最大迭代次数，防止死循环，常设为$$10~20$$;
  (2)tolerance：收敛容忍度，决定解的精度，常设为$$1e-6$$或更小;
  (3)n_points：离散点数，越大精度越高但计算量增加，通常取$$50~200$$。
...
| scipy.solve_bvp | [几乎100%] | [3.67e-08] | [1.62e-08] | [0.0107 s] |
